...
namespace TestProject1.EntityFrameworkCore.UnitOfWork
{
    ...
    public class EntityFrameworkCoreManagerUowTest : IClassFixture<EntityFrameworkCoreUowTestFixture>
    {
        private readonly EntityFrameworkCoreUowTestFixture _fixture;
        private readonly ITestOutputHelper _output;

        public EntityFrameworkCoreManagerUowTest(EntityFrameworkCoreUowTestFixture fixture, ITestOutputHelper output)
        {
            _fixture = fixture;
            _output = output;
        }
